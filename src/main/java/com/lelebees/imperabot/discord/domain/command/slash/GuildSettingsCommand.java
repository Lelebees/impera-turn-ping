...
public class GuildSettingsCommand implements SlashCommand {
    ...
    public Mono<Void> handle(ChatInputInteractionEvent event) {
        ...
        return event.reply().withComponents(SettingsMenu.buildForGuild(settings, guild, settings.userHasEditPermission(callingUser))).withAllowedMentions(AllowedMentions.suppressAll());
    }
}
